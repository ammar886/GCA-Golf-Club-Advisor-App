...
import 'course_list_item_model.dart';
export 'course_list_item_model.dart';
...
class CourseListItemWidget extends StatefulWidget {
  const CourseListItemWidget({
    ...
    String? update,
        ...
        this.name = name ?? 'St Andrews Links',
        this.rating = rating ?? '4.9',
        this.update = update ?? 'Greens: 10.5';
...
class _CourseListItemWidgetState extends State<CourseListItemWidget> {
  late CourseListItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CourseListItemModel());
