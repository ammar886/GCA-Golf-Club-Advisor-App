...
import '/pages/admin/components/delete_club/delete_club_widget.dart';
import '/index.dart';
                      ...
                      Expanded(
                        child: FutureBuilder<List<GolfClubsRow>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<GolfClubsRow> containerGolfClubsRowList =
                                snapshot.data!;
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 10.0),
                                    child: Text(
                                      'Total Clubs: ${containerGolfClubsRowList.length.toString()}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inter(
                                  ...
                                  Expanded(
                                    child: Builder(
                                      builder: (context) {
                                        final golfClubs = (_model.isSearchOn
                                                    ? _model.searchRes
                                                    : containerGolfClubsRowList)
                                                ?.toList() ??
                                            [];
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemCount: golfClubs.length,
                                          separatorBuilder: (_, __) =>
                                              SizedBox(height: 12.0),
                                          itemBuilder:
                                              (context, golfClubsIndex) {
                                            final golfClubsItem =
                                                golfClubs[golfClubsIndex];
                                            return Container(
                                              width: double.infinity,
                                              child: Stack(
                                                          ...
                                                          ClipRRect(
                                                            ...
                                                            child:
                                                              ...
                                                              valueOrDefault<
                                                                ...
                                                                golfClubsItem
                                                                    .imageUrl,
                                                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4nHTjDIdIkWfLWyfMMWeGgpaDxDlQKGUaew4S5nLXtw&s=10',
                                                              ),
                                                              width: 80.0,
                                                              height: 80.0,
                                                              fit: BoxFit.cover,
