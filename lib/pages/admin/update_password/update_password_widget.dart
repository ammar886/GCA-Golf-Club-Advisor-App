                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if ((_model.apiResultdlf?.succeeded ??
                                        true)) {
                                      safeSetState(() {
                                        _model.currentPassTextController
                                            ?.clear();
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Password changed. You’ll be logged out shortly.',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                      ...
                                      if (UpdatePasswordCall.error(
                                            (_model.apiResultdlf?.jsonBody ??
                                                ''),
                                          ) ==
                                      ...
                                      } else if (UpdatePasswordCall.error(
                                            (_model.apiResultdlf?.jsonBody ??
                                                ''),
                                          ) ==
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'New & Old Passwords cannot be same.',
                                              style: TextStyle(
                                                color:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
