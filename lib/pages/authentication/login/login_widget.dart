                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        if ((_model.authUser?.firstOrNull?.isBlocked ==
                                false) ||
                            (_model.authUser?.firstOrNull?.isBlocked == null)) {
                          FFAppState().currentRole =
                              _model.authUser!.firstOrNull!.role!;
                          safeSetState(() {});
                          if ((_model.authUser?.firstOrNull?.role == 'admin') ||
                              (_model.authUser?.firstOrNull?.role ==
                                  'subAdmin')) {
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Access Disabled'),
                                content: Text(
                                    'You have been blocked from accessing the platform. You\'ll be logged-ouit shortly'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
