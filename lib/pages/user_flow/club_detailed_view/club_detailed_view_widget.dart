...
class ClubDetailedViewWidget extends StatefulWidget {
  const ClubDetailedViewWidget({
    super.key,
    this.clubDetails,
  });
  ...
  static String routeName = 'clubDetailedView';
  static String routePath = '/clubDetailedView';

  @override
  State<ClubDetailedViewWidget> createState() => _ClubDetailedViewWidgetState();
}

class _ClubDetailedViewWidgetState extends State<ClubDetailedViewWidget>
    with TickerProviderStateMixin {
  late ClubDetailedViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClubDetailedViewModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.coursesInClub = await GolfCoursesTable().queryRows(
          ...
          child: Stack(
            ...
            children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            final courses = _model.coursesInClub
                                                    ?.sortedList(
                                                        keyOf: (e) => e.id,
                                                        desc: false)
                                                    .toList() ??
              ...
              if (responsiveVisibility(
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 16.0, 25.0),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
