                ...
                children: [
                  Stack(
                    ...
                    children: [
                      Builder(
                        builder: (context) {
                          if (_model.profilePicture == null ||
                              (_model.profilePicture?.bytes?.isEmpty ?? true)) {
                            return Container(
                              width: 60.0,
                              height: 60.0,
                            ...
                            return Container(
                              ...
                              child: Image.memory(
                                _model.uploadedLocalFile_uploadData967.bytes ??
                                    Uint8List.fromList([]),
                                fit: BoxFit.cover,
                              ),
                            );
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadData967 = true);
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context)
                                      .hideCurrentSnackBar();
                                  _model.isDataUploading_uploadData967 = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadData967 =
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (_model.profilePicture != null &&
                          (_model.profilePicture?.bytes?.isNotEmpty ?? false)) {
                        {
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataWlc = true);
                          var selectedUploadedFiles = <FFUploadedFile>[];
                          var selectedMedia = <SelectedFile>[];
                          var downloadUrls = <String>[];
                          try {
                            selectedUploadedFiles = _model
                                    .uploadedLocalFile_uploadData967
                                    .bytes!
                                    .isNotEmpty
                                ? [_model.uploadedLocalFile_uploadData967]
                                : <FFUploadedFile>[];
                            ...
                            _model.isDataUploading_uploadDataWlc = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedMedia.length &&
                              downloadUrls.length == selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataWlc =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataWlc =
                                  downloadUrls.first;
                            });
                          } else {
                            safeSetState(() {});
